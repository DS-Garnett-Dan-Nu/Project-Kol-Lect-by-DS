...
func _on_timer_timeout():
		#For service station event
	if AutoLoad.service_station_appear == AutoLoad.service_station_spawn_pt_1 or AutoLoad.service_station_appear == AutoLoad.service_station_spawn_pt_2 or AutoLoad.service_station_appear == AutoLoad.service_station_spawn_pt_3:
		AutoLoad.platform_normal = true
		AutoLoad.platform_wide = false
		
		#For Boss Event
	if 	AutoLoad.service_station_appear == 39:
		AutoLoad.platform_normal = false
		AutoLoad.platform_wide = true
		
	if 	AutoLoad.service_station_appear == 40:
		AutoLoad.platform_normal = true
		AutoLoad.platform_wide = false
